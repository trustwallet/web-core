            ...
            <>
                <Card>
                    ...
                    <Card.Body>
                        <Card.Title>
                            Trust Provider{' '}
                            <Badge variant={Provider.isAvailable ? 'success' : 'danger'}>
                                {Provider.isAvailable ? 'is available' : 'is not Available'}
                            </Badge>
                        </Card.Title>
                        <Button size="lg" disabled={!Provider.isAvailable} onClick={this.testGetAccounts}>
                            Get Accounts
                        </Button>
                    </Card.Body>
                </Card>
                <Card>
                    ...
                    <Card.Body>
                        <Button size="lg" disabled={!Provider.isAvailable} onClick={this.testCosmosSendCoins}>
                            Send Coins
                        </Button>
                        <Button size="lg" disabled={!Provider.isAvailable} onClick={this.testCosmosStake}>
                            Stake
                        </Button>
                        <Button size="lg" disabled={!Provider.isAvailable} onClick={this.testCosmosUnstake}>
                            Unstake
                        </Button>
                        <Button size="lg" disabled={!Provider.isAvailable} onClick={this.testCosmosWithdraw}>
                            Withdraw
                        </Button>
                    </Card.Body>
                </Card>
